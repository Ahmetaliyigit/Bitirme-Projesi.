...
{
    public partial class UserPantolonGuncelle : Form
    {
        ...
        private void btn_Ekle_Click(object sender, EventArgs e)
        {
            ...
            if (donus == true && Guncel != null)
            {
                ...
                varmi.Length = string.IsNullOrEmpty(lst_Pant.Text) ? varmi.Length : Convert.ToInt32(lst_Pant.Text);
                varmi.Waistsize = string.IsNullOrEmpty(lst_Bel.Text) ? varmi.Waistsize : Convert.ToInt32(lst_Bel.Text);
                ...
                varmi.Size = string.IsNullOrEmpty(lst_Bedenler1.Text) ? varmi.Size : lst_Bedenler1.Text;
                ...
                var productList = context.pants.Where(k => k.Type == varmi2.Name).ToList();
