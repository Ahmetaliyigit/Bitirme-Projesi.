...
{
    public partial class UserTisortGuncelle : Form
    {
        public UserTisortGuncelle()
        {
            InitializeComponent();
        }
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            var productList = context.Tshirts.Where(k => k.Type == varmi.Name).ToList();
        ...
        private void btn_Ekle_Click(object sender, EventArgs e)
        {
            ...
            {
                var varmi = Guncel.Tshirts.Where(k => k.Id == Convert.ToInt32(txt_Id.Text)).FirstOrDefault();
                ...
                varmi.Collar = string.IsNullOrEmpty(lst_Yaka2.Text) ? varmi.Collar : lst_Yaka2.Text;
                ...
                var productList = context.Tshirts.Where(k => k.Type == varmi2.Name).ToList();
